...
export default function StackNavigator({ hidden, setHidden }: Props) {
    ...
    <Stack.Screen 
      ...
      options={{
        header: () => (
          <>
            <View>
              <Image source={require("../assets/leftArrow.png")} style={{width: 15, height: 15}} />
        ...
        header: () => (
          <>
            <View style={styles.header}>
              ...
              }}><Image source={require("../assets/search.png")} style={{width: 25, height: 25}}/></TouchableHighlight>
            </View>
          </>
        )
      }}
